...
class Removemember extends ApiBase
{
    public function handle(Request $request): array
    {
        ...
        if (!$currentMember->hasPermission('team.remove_user')) {
            $this->setFail();
            $this->setResponseCode(403);

            return ['message' => 'You do not have permission to remove members.'];
        }
        ...
        if ($targetMember->isOwner()) {
            ...
            return ['message' => 'The team owner cannot be removed.'];
        }
